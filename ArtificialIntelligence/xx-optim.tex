...
\blob Iterated Local Search

\blob Simulated annealing \& Genetic algorithms (briefly)

\blob General formulation of optimization problems

\blob LP, QP, ILP, non-linear program

\blob ILP formulations of $n$-queens, CSP, TSP
